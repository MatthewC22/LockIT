...
c.execute("""CREATE TABLE DOCUMENT(
    ...
    USERID    INT (3),
    DATEADDED DATE,
    CONSTRAINT DOCUMENT_ID_PK PRIMARY KEY (
        ID
    ),
...
c.execute("INSERT INTO CATEGORY (CATEGORY_NAME,COLOR_ID,USER_ID) VALUES('SCHOOL',1,1)")
c.execute("INSERT INTO CATEGORY (CATEGORY_NAME,COLOR_ID,USER_ID) VALUES('HOME',2,1)")
c.execute("INSERT INTO CATEGORY (CATEGORY_NAME,COLOR_ID,USER_ID) VALUES('WORK',3,1)")


# inserts into the PASSWORD table
c.execute("INSERT INTO PASSWORD (ENTRY_NAME,WEBSITE,USERNAME,PASSWORD,SECURITY_QUEST,NUM_SECURITY_ANSWER,ANSWER_1,ANSWER_2,ANSWER_3,ANSWER_4,ANSWER_5,NOTES,CATEGORY,S_LEVEL,DATE_CREATED)"
          " VALUES('BLUE HOST','','DREAMTRIM',76543,1,5,'CHINA','ICE CREAM','PIZZA','ALISA','APPLE','TESTING NOTES',1,3,CURRENT_DATE)")

c.execute("INSERT INTO PASSWORD (ENTRY_NAME,WEBSITE,USERNAME,PASSWORD,SECURITY_QUEST,NUM_SECURITY_ANSWER,ANSWER_1,ANSWER_2,ANSWER_3,ANSWER_4,ANSWER_5,NOTES,CATEGORY,S_LEVEL,DATE_CREATED)"
          " VALUES('SENECA','https://my.senecacollege.ca','EGRINBERG',88765,0,0,'','','','','','',1,2,CURRENT_DATE)")
